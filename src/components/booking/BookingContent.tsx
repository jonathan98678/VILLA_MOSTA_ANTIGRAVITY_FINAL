...
import { ChevronLeft, ChevronRight, Check, CreditCard, Lock } from "lucide-react";
...
export function BookingContent({ rooms }: { rooms: BookingRoom[] }) {
                                            ...
                                            >
                                                <div className="flex gap-4">
                                                    <div className="w-20 h-20 bg-cream-300 rounded flex-shrink-0">
                                                        ...
                                                        <img src={room.image} alt={room.name} className="w-full h-full object-cover rounded" />
                                                    </div>
                                                    <div>
